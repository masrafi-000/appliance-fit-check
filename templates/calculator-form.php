...
-->
    ...
    <div class="bg-linear-to-br from-slate-800 to-slate-900 mb-5 rounded-2xl px-4 pt-4 pb-4 mt-2">
      ...
      <div class="flex items-center justify-center gap-2">
        <!-- Apple Store Button -->
        <div id="button-apple-store" class="app-btn flex-1 flex items-center justify-center gap-3 bg-white rounded-xl px-3.5 py-2.5 cursor-pointer hover:bg-slate-50 transition-colors shadow-md shadow-black/20">
